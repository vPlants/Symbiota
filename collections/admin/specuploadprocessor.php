				...
				<fieldset style="margin:15px;">
					...
					<div style="margin:5px;">
						...
						if($reportArr['update']){
							...
							echo ' <a href="uploadreviewer.php?collid=' . htmlspecialchars($collid, HTML_SPECIAL_CHARS_FLAGS) . '&searchvar=' . htmlspecialchars($searchVar, HTML_SPECIAL_CHARS_FLAGS) . '" target="_blank" title="' . htmlspecialchars($LANG['PREVIEW'], HTML_SPECIAL_CHARS_FLAGS) . '"><img src="../../images/list.png" style="width:1.2em;" /></a>';
							echo ' <a href="uploadreviewer.php?action=export&collid=' . htmlspecialchars($collid, HTML_SPECIAL_CHARS_FLAGS) . '&searchvar=' . htmlspecialchars($searchVar, HTML_SPECIAL_CHARS_FLAGS) . '" target="_self" title="' . htmlspecialchars($LANG['DOWNLOAD_RECS'], HTML_SPECIAL_CHARS_FLAGS) . '"><img src="../../images/dl.png" style="width:1.2em;" /></a>';
						...
						if($uploadType != $NFNUPLOAD || $reportArr['new']){
							...
							echo $reportArr['new'];
							if($reportArr['new']){
								echo ' <a href="uploadreviewer.php?collid=' . htmlspecialchars($collid, HTML_SPECIAL_CHARS_FLAGS) . '&searchvar=occid:ISNULL" target="_blank" title="' . htmlspecialchars((isset($LANG['PREVIEW']) ? $LANG['PREVIEW'] : 'Preview 1st 1000 Records'), HTML_SPECIAL_CHARS_FLAGS) . '"><img src="../../images/list.png" style="width:1.2em;" /></a>';
								echo ' <a href="uploadreviewer.php?action=export&collid=' . htmlspecialchars($collid, HTML_SPECIAL_CHARS_FLAGS) . '&searchvar=occid:ISNULL" target="_self" title="' . htmlspecialchars((isset($LANG['DOWNLOAD_RECS']) ? $LANG['DOWNLOAD_RECS'] : 'Download Records'), HTML_SPECIAL_CHARS_FLAGS) . '"><img src="../../images/dl.png" style="width:1.2em;" /></a>';
						...
						if(isset($reportArr['matchappend']) && $reportArr['matchappend']){
							...
							if($reportArr['matchappend']){
								echo ' <a href="uploadreviewer.php?collid=' . htmlspecialchars($collid, HTML_SPECIAL_CHARS_FLAGS) . '&searchvar=matchappend" target="_blank" title="' . htmlspecialchars((isset($LANG['PREVIEW']) ? $LANG['PREVIEW'] : 'Preview 1st 1000 Records'), HTML_SPECIAL_CHARS_FLAGS) . '"><img src="../../images/list.png" style="width:1.2em;" /></a>';
								echo ' <a href="uploadreviewer.php?action=export&collid=' . htmlspecialchars($collid, HTML_SPECIAL_CHARS_FLAGS) . '&searchvar=matchappend" target="_self" title="' . htmlspecialchars((isset($LANG['DOWNLOAD_RECS']) ? $LANG['DOWNLOAD_RECS'] : 'Download Records'), HTML_SPECIAL_CHARS_FLAGS) . '"><img src="../../images/dl.png" style="width:1.2em;" /></a>';
							}
							echo '</div>';
						...
						if($uploadType != $NFNUPLOAD && $uploadType != $SKELETAL){
							if(isset($reportArr['sync']) && $reportArr['sync']){
								...
								echo $reportArr['sync'];
								if($reportArr['sync']){
									echo ' <a href="uploadreviewer.php?collid=' . htmlspecialchars($collid, HTML_SPECIAL_CHARS_FLAGS) .'&searchvar=sync" target="_blank" title="' . htmlspecialchars((isset($LANG['PREVIEW']) ? $LANG['PREVIEW'] : 'Preview 1st 1000 Records'), HTML_SPECIAL_CHARS_FLAGS) . '"><img src="../../images/list.png" style="width:1.2em;" /></a>';
									echo ' <a href="uploadreviewer.php?action=export&collid=' . htmlspecialchars($collid, HTML_SPECIAL_CHARS_FLAGS) .'&searchvar=sync" target="_self" title="' . htmlspecialchars((isset($LANG['DOWNLOAD_RECS']) ? $LANG['DOWNLOAD_RECS'] : 'Download Records'), HTML_SPECIAL_CHARS_FLAGS) . '"><img src="../../images/dl.png" style="width:1.2em;" /></a>';
								}
								echo '</div>';
							...
							if(isset($reportArr['nulldbpk']) && $reportArr['nulldbpk']){
								...
								if($reportArr['nulldbpk']){
									echo ' <a href="uploadreviewer.php?collid=' . htmlspecialchars($collid, HTML_SPECIAL_CHARS_FLAGS) .'&searchvar=dbpk:ISNULL" target="_blank" title="' . htmlspecialchars((isset($LANG['PREVIEW']) ? $LANG['PREVIEW'] : 'Preview 1st 1000 Records'), HTML_SPECIAL_CHARS_FLAGS) . '"><img src="../../images/list.png" style="width:1.2em;" /></a>';
									echo ' <a href="uploadreviewer.php?action=export&collid=' . htmlspecialchars($collid, HTML_SPECIAL_CHARS_FLAGS) .'&searchvar=dbpk:ISNULL" target="_self" title="' . htmlspecialchars((isset($LANG['DOWNLOAD_RECS']) ? $LANG['DOWNLOAD_RECS'] : 'Download Records'), HTML_SPECIAL_CHARS_FLAGS) . '"><img src="../../images/dl.png" style="width:1.2em;" /></a>';
								}
								echo '</div>';
							}
							if(isset($reportArr['dupdbpk']) && $reportArr['dupdbpk']){
								...
								if($reportArr['dupdbpk']){
									echo ' <a href="uploadreviewer.php?collid=' . htmlspecialchars($collid, HTML_SPECIAL_CHARS_FLAGS) .'&searchvar=dupdbpk" target="_blank" title="' . htmlspecialchars((isset($LANG['PREVIEW']) ? $LANG['PREVIEW'] : 'Preview 1st 1000 Records'), HTML_SPECIAL_CHARS_FLAGS) . '"><img src="../../images/list.png" style="width:1.2em;" /></a>';
									echo ' <a href="uploadreviewer.php?action=export&collid=' . htmlspecialchars($collid, HTML_SPECIAL_CHARS_FLAGS) .'&searchvar=dupdbpk" target="_self" title="' . htmlspecialchars((isset($LANG['DOWNLOAD_RECS']) ? $LANG['DOWNLOAD_RECS'] : 'Download Records'), HTML_SPECIAL_CHARS_FLAGS) . '"><img src="../../images/dl.png" style="width:1.2em;" /></a>';
								}
								echo '</div>';
							}
						}
