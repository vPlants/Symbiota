					...
					<div>
						...
						if($sourceArr){
							...
							if($isEditor && $tid){
								?>
								<div style="float:left;margin-left:5px;">
									(<a href="sources.php?emode=1&tid=<?php echo $tid.'&searchterm='.htmlspecialchars($searchTerm, HTML_SPECIAL_CHARS_FLAGS).'&language='.$language; ?>"><?php echo (isset($LANG['ADD_SRC'])?$LANG['ADD_SRC']:'Add Sources'); ?></a>)
								</div>
								<?php
							}
						}
