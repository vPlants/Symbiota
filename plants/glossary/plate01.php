...
<html>
<head>
	<title><?php echo $DEFAULT_TITLE; ?> vPlants - Plate 1 - Stem and Root Types</title>
				...
				<div id="wrapper1"><!-- for navigation and content -->
					...
					<div id="content1"><!-- start of primary content --><a id="pagecontent" name="pagecontent"></a>
						...
						<div style="margin:20px;">
							...
							<div class="plate">
							<img src="<?php echo $CLIENT_ROOT; ?>/images/vplants/plants/glossary/plate01.jpg" width="712" height="1055"
