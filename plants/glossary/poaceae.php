...
<html>
<head>
	<title><?php echo $DEFAULT_TITLE; ?>vPlants - Glossary Poaceae</title>
				...
				<div id="wrapper1"><!-- for navigation and content -->
					...
					<div id="content1"><!-- start of primary content --><a id="pagecontent" name="pagecontent"></a>
						...
						<div style="margin:20px;">
							...
							<div class="plate">
							<img src="<?php echo $CLIENT_ROOT; ?>/images/vplants/plants/glossary/plate12_grass.jpg" width="703" height="367"
