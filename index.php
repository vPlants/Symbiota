		...
		<tr>
			<td style="background: #360; vertical-align: top;">
				<div id="" style="height:100%">
					<ul class="sitemenu" style="padding-top:8px;">
						<li>
							<a class="start" href="<?php echo $CLIENT_ROOT; ?>/about/index.php">About Us</a>
							<ul>
								<li>
									<a href="<?php echo $CLIENT_ROOT; ?>/about/vplants.php">vPlants Project</a>
								</li>
								<li>
									<a href="<?php echo $CLIENT_ROOT; ?>/about/chicago.php">Chicago Region</a>
								</li>
								<li>
									<a href="<?php echo $CLIENT_ROOT; ?>/about/partnership.php">vPlants Partnership</a>
								</li>
								<li>
									<a href="<?php echo $CLIENT_ROOT; ?>/about/contact.php">Contact Us</a>
								</li>
								<li>
									<a href="<?php echo $CLIENT_ROOT; ?>/about/credits.php">Credits</a>
								</li>
							</ul>
						</li>
					</ul>
					<ul class="sitemenu" style="margin-top:6px;">
						<li>
							<a class="plant" href="<?php echo $CLIENT_ROOT; ?>/plants/index.php">Plants</a>
							<ul>
								<li>
									<a href="<?php echo $CLIENT_ROOT; ?>/plants/chicagoplants.php">Chicago Plants</a>
								</li>
								<li>
									<a href="<?php echo $CLIENT_ROOT; ?>/plants/guide/index.php">Guide</a>
								</li>
								<li>
									<a href="<?php echo $CLIENT_ROOT; ?>/plants/glossary/index.php">Glossary</a>
								</li>
								<li>
									<a href="<?php echo $CLIENT_ROOT; ?>/plants/biology.php">Biology</a>
								</li>
								<li>
									<a href="<?php echo $CLIENT_ROOT; ?>/plants/diversity.php">Diversity</a>
								</li>
								<li>
									<a href="<?php echo $CLIENT_ROOT; ?>/plants/habitats.php">Habitats</a>
								</li>
								<li>
									<a href="<?php echo $CLIENT_ROOT; ?>/plants/origin.php">Origin</a>
								</li>
								<li>
									<a href="<?php echo $CLIENT_ROOT; ?>/plants/distribution.php">Distribution</a>
								</li>
								<li>
									<a href="<?php echo $CLIENT_ROOT; ?>/plants/names.php">Names</a>
								</li>
								<li>
									<a href="<?php echo $CLIENT_ROOT; ?>/plants/collections.php">Collections</a>
								</li>
								<li>
									<a href="<?php echo $CLIENT_ROOT; ?>/plants/concern.php">Special Concern</a>
								</li>
							</ul>
						</li>
					</ul>
					<ul class="sitemenu" style="margin-top:6px;">
						<li>
							<a class="start" href="<?php echo $CLIENT_ROOT; ?>/resources/index.php">Resources</a>
							<ul>
								<li>
									<a href="<?php echo $CLIENT_ROOT; ?>/resources/regionherbaria.php">Region Herbaria</a>
								</li>
								<li>
									<a href="<?php echo $CLIENT_ROOT; ?>/resources/docs.php">Documents</a>
								</li>
								<li>
									<a href="<?php echo $CLIENT_ROOT; ?>/resources/biblio.php">References</a>
								</li>
								<li>
									<a href="<?php echo $CLIENT_ROOT; ?>/resources/links.php">Links</a>
								</li>
							</ul>
						</li>
					</ul>
