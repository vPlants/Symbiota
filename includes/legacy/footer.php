	...
	<tr>
		<td colspan="3">
	        <div id="sitefoot"><a id="menu4" name="menu4"></a>
				...
				<p>
					<a href="<?php echo $clientRoot; ?>/about/partner_mor.php" title="Read about this partner.">The Morton Arboretum</a>, 
					<a href="<?php echo $clientRoot; ?>/about/partner_f.php" title="Read about this partner.">The Field Museum</a>, 
					<a href="<?php echo $clientRoot; ?>/about/partner_chic.php" title="Read about this partner.">Chicago Botanic Garden</a>, 
					<a href="<?php echo $clientRoot; ?>/about/partner_other.php" title="Read about other partners.">Additional Partners</a>
				</p>
