...
?>
<?php echo ($DEFAULT_TITLE) ? $DEFAULT_TITLE : "Name of people or institutional responsible for maintaining the portal"; ?> (<?php echo date('Y'); ?>). <?php echo $collData['gbiftitle']; ?>. Occurrence dataset https://doi.org/<?php echo $collData['doi']; ?> accessed via the <?php echo ($DEFAULT_TITLE) ? $DEFAULT_TITLE : "Custom title for the portal"; ?>, <?php echo $SERVER_HOST . $CLIENT_ROOT; ?> on <?php echo date('Y-m-d'); ?>.
