...
$LANG['RETRIEVE_RESET_MSG'] = 'Si se encuentra una cuenta válida, se enviará un correo electrónico con su información en breve. Si el mensaje para restablecer la contraseña no aparece pronto en su bandeja de entrada, revise su carpeta de spam o correo no deseado. Póngase en contacto con un administrador si no lo recibe.';
