...
$LANG['SEPARATE_TERMS'] = 'Separate multiple terms by comma and ranges by \' - \' (space before and after dash required), e.g.: 3542,3602,3700 - 3750';
$LANG['REC_NUM'] = 'Record Number(s):';
$LANG['CAT_NUM'] = 'Catalog Number(s):';
...
$LANG['ALL_PROJ'] = 'All Projects';
$LANG['SEARCH_OUT'] = 'Search outside user profile';
$LANG['SEARCH_IN'] = 'Search within all collections';
$LANG['FILT_SPEC_REC'] = 'Filter Specimen Records';
$LANG['SPEC_LIM'] = '* Specimen return is limited to 1000 records';
$LANG['QTY'] = 'Qty';
...
$LANG['HEAD_PREFIX'] = 'Heading Prefix:';
$LANG['E_G_PLANTS'] = '(e.g. Plants of, Insects of, Vertebrates of)';
$LANG['HEAD_MID'] = 'Heading Mid-Section:';
$LANG['COUNTRY'] = 'Country';
$LANG['STATE'] = 'State';
$LANG['COUNTY'] = 'County';
$LANG['FAMILY'] = 'Family';
$LANG['BLANK'] = 'Blank';
$LANG['HEAD_SUFF'] = 'Heading Suffix:';
$LANG['FOOTER'] = 'Footer:';
$LANG['PRINT_AUTH'] = 'Print species authors for infraspecific taxa';
$LANG['PRINT_CAT_NUM'] = 'Print Catalog Numbers';
$LANG['INCL_BARCODE'] = 'Include barcode of Catalog Number';
$LANG['PRINT_BARCODE'] = 'Print only Barcode';
