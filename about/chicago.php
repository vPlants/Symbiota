...
<html>
<head>
	<title><?php echo $DEFAULT_TITLE; ?>About Us - The Chicago Region</title>
				...
				<div id="wrapper1"><!-- for navigation and content -->
					...
					<div id="content2"><!-- start of side content -->
						...
						<div class="box">
						  ...
						  <p><img src="<?php echo $CLIENT_ROOT; ?>/images/vplants/img/map_na.gif" width="210" height="210" 
						  ...
						  <p><a href="map.php" title="See State Map for Chicago Region."><img class="border" src="<?php echo $CLIENT_ROOT; ?>/images/vplants/img/map_grtlakes_250.jpg" width="240" height="212"
						  ...
						  <p><a href="map_county.php" title="See County Map for Chicago Region."><img class="border" src="<?php echo $CLIENT_ROOT; ?>/images/vplants/img/map_vplants.gif" width="240" height="212"
