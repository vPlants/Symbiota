		...
		if($rs = $this->conn->query($sql)){
			...
			while($r = $rs->fetch_object()){
				$editLink = '[<a href="#" onclick="openPopup(\'' . htmlspecialchars($GLOBALS['CLIENT_ROOT'], HTML_SPECIAL_CHARS_FLAGS) .
					...
					htmlspecialchars($this->collid, HTML_SPECIAL_CHARS_FLAGS) . '\'); return false;">' . htmlspecialchars($r->cnt, HTML_SPECIAL_CHARS_FLAGS) . ' specimens <img src="../../images/edit.png" style="width:1.2em;" /></a>]';
