...
<html>
<head>
	<title><?php echo $DEFAULT_TITLE; ?>vPlants - Guide to Agarics Gills Free Key 4</title>
	...
	?> 
        ...
        <div  id="innervplantstext">
            ...
            <div style="margin:20px;">
				...
				<caption>Key to Mushroom Genera with Free Gills.<br> Step 4: <i>Lepiota</i> Group, the Parasol Mushrooms</caption>
				<tbody>
				...
				<td><div><img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/LEPI2/LEPI2_300_whole.jpg" width="300" height="222" alt=""></div>
				<p>
				</p>
				</td>
				</tr>
