...
<html>
<head>
	<title><?php echo $DEFAULT_TITLE; ?>vPlants - Guide to Boletes</title>
	...
	?> 
        ...
        <div  id="innervplantstext">
            ...
            <div style="margin:20px;">
            	 <div class="floatimg"><img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/LECC/LECC.po.jpg" width="250" height="311" alt=""></div>
