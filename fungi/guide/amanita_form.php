	...
	?> 
        ...
        <div  id="innervplantstext">
            ...
            <div style="margin:20px;">
				...
				<img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/color/white.gif" width="125" height="100" alt="">
				</td><td >
				<p><input id="yellow" name="yellow" type="checkbox" value="yellow">
				<label for="yellow">Yellow</label></p>
				<img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/color/yellow.jpg" width="125" height="100" alt="">
				</td><td >
				<p><input id="orange" name="orange" type="checkbox" value="orange">
				<label for="orange">Orange</label></p>
				<img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/color/orange.jpg" width="125" height="100" alt="">
				</td><td >
				<p><input id="redbrown" name="redbrown" type="checkbox" value="redbrown">
				<label for="redbrown">Reddish Brown</label></p>
				<img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/color/redbrown.jpg" width="125" height="100" alt="">
				</td><td >
				<p><input id="yellowbrown" name="yellowbrown" type="checkbox" value="yellowbrown">
				<label for="yellowbrown">Yellow Brown</label></p>
				<img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/color/yellowbrown.jpg" width="125" height="100" alt="">
				</td><td >
				<p><input id="brown" name="brown" type="checkbox" value="brown">
				<label for="brown">Brown</label></p>
				<img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/color/brown.jpg" width="125" height="100" alt="">
				</td><td >
				<p><input id="graybrown" name="graybrown" type="checkbox" value="graybrown">
				<label for="graybrown">Grayish Brown</label></p>
				<img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/color/graybrown.jpg" width="125" height="100" alt="">
				</td><td >
				<p><input id="gray" name="gray" type="checkbox" value="gray">
				<label for="gray">Gray</label></p>
				<img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/color/gray.jpg" width="125" height="100" alt="">
				</td>
				</tr></table>
				...
				<img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/cap/margin_smooth.jpg" width="125" height="100" alt="">
				</td><td >
				...
				<img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/cap/margin_striate.jpg" width="125" height="100" alt="">
				</td><td >
				...
				<img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/cap/margin_appendiculate.jpg" width="125" height="100" alt="">
				</td>
				</tr></table>
				...
				<img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/cap/warts_none.jpg" width="125" height="100" alt="">
				</td><td >
				<p><input id="warts_patch" name="warts_patch" type="checkbox" value="warts_patch">
				<label for="warts_patch">Patch(es)</label></p>
				<img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/cap/warts_patch.jpg" width="125" height="100" alt="">
				</td><td >
				<p><input id="warts_erect" name="warts_erect" type="checkbox" value="warts_erect">
				<label for="warts_erect">Erect Warts</label></p>
				<img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/cap/warts_erect.jpg" width="125" height="100" alt="">
				</td><td >
				<p><input id="warts_flat" name="warts_flat" type="checkbox" value="warts_flat">
				<label for="warts_flat">Flat Warts</label></p>
				<img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/cap/warts_flat.jpg" width="125" height="100" alt="">
				</td><td >
				<p><input id="warts_felty" name="warts_felty" type="checkbox" value="warts_felty">
				<label for="warts_felty">Felty Patches</label></p>
				<img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/cap/warts_felty.jpg" width="125" height="100" alt="">
				</td><td >
				<p><input id="warts_powdery" name="warts_powdery" type="checkbox" value="warts_powdery">
				<label for="warts_powdery">Powdery</label></p>
				<img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/cap/warts_powdery.jpg" width="125" height="100" alt="">
				</td>
				</tr></table>
				...
				<img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/stem/base_cup.jpg" width="125" height="100" alt="">
				</td><td >
				<p><input id="base_deepcup" name="base_deepcup" type="checkbox" value="base_deepcup">
				<label for="base_deepcup">Deep Cup</label></p>
				<img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/stem/base_deepcup.jpg" width="125" height="100" alt="">
				</td><td >
				<p><input id="base_collar" name="base_collar" type="checkbox" value="base_collar">
				<label for="base_collar">Collar</label></p>
				<img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/stem/base_collar.jpg" width="125" height="100" alt="">
				</td><td >
				<p><input id="base_rim" name="base_rim" type="checkbox" value="base_rim">
				<label for="base_rim">Rim</label></p>
				<img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/stem/base_rim.jpg" width="125" height="100" alt="">
				</td><td >
				<p><input id="base_ridge" name="base_ridge" type="checkbox" value="base_ridge">
				<label for="base_ridge">Ridge</label></p>
				<img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/stem/base_ridge.jpg" width="125" height="100" alt="">
				</td><td >
				...
				<img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/stem/base_indistinct.jpg" width="125" height="100" alt="">
				</td><td >
				<p><input id="base_powdery" name="base_powdery" type="checkbox" value="base_powdery">
				<label for="base_powdery">Powdery</label></p>
				<img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/stem/base_powdery.jpg" width="125" height="100" alt="">
				</td>
				</tr></table>
				...
				<img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/color/pinkishtan.jpg" width="125" height="100" alt="">
				</td><td >
				<p><input id="graybrown" name="graybrown" type="checkbox" value="graybrown">
				<label for="graybrown">Grayish Brown</label></p>
				<img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/color/graybrown.jpg" width="125" height="100" alt="">
				...
				<img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/stem/pveil_absent.jpg" width="125" height="100" alt="">
				</td><td >
				<p><input id="pveil_ring" name="pveil_ring" type="checkbox" value="pveil_ring">
				<label for="pveil_ring">Ring or Collar</label></p>
				<img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/stem/pveil_ring.jpg" width="125" height="100" alt="">
				</td><td >
				<p><input id="pveil_skirt" name="pveil_skirt" type="checkbox" value="pveil_skirt">
				<label for="pveil_skirt">Skirt or Hanging</label></p>
				<img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/stem/pveil_skirt.jpg" width="125" height="100" alt="">
				</td><td >
				...
				<img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/stem/pveil_cotton.jpg" width="125" height="100" alt="">
				</td>
				</tr></table>
				...
				<img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/img/none.gif" width="125" height="100" alt="">
				</td><td >
				<p><input id="koh_yellow" name="koh_yellow" type="checkbox" value="koh_yellow">
				<label for="koh_yellow">Yellow with KOH</label></p>
				<img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/temp/koh_yellow.jpg" width="125" height="100" alt="">
				</td><td >
				<p><input id="stain_red" name="stain_red" type="checkbox" value="stain_red">
				<label for="stain_red">Staining Reddish</label></p>
				<img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/stem/stain_red.jpg" width="125" height="100" alt="">
				</td>
				</tr></table>
