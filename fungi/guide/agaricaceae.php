...
<html>
<head>
	<title><?php echo $DEFAULT_TITLE; ?>vPlants - Guide to Agaricaceae</title>
	...
	?>
        ...
        <div  id="innervplantstext">
            ...
            <div style="margin:20px;">
				...
				<tr class="keychoice">
				<td ><img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/LANG/LANGGIGA_125_whole.jpg" width="125" height="100" alt=""></td>
				<td >
				...
				<td><div><img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/spore/gleba_olive.jpg" width="125" height="100" alt=""></div></td>
				</tr>

				<tr class="keychoice">
				<td ><img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/CALV/CALV_125_cracks.jpg" width="125" height="100" alt=""></td>
				<td >
				...
				<td><div><img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/spore/gleba_olive_purplish.jpg" width="125" height="100" alt=""></div></td>
				</tr>
				...
				<tr class="keychoice">
				<td ><img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/LYCO2/LYCO2PERL_125_group.jpg" width="125" height="100" alt=""></td>
				<td >
