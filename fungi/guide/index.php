	...
	?>
        ...
        <div  id="innervplantstext">
            ...
            <div style="margin:20px;">
				...
				<td ><img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/img/g_basidium.gif" width="125" height="100" alt=""></td>
				</tr><tr >

				<tr class="keychoice">
				<td ><img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/img/g_agarics.gif" width="125" height="100" alt=""></td>
				<td >
				...
				<td ><img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/img/g_agarics.jpg" width="125" height="100" alt=""></td>
				</tr><tr >

				<tr class="keychoice">
				<td ><img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/img/g_boletes.gif" width="125" height="100" alt=""></td>
				<td >
				...
				<td ><img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/img/g_boletes.jpg" width="125" height="100" alt=""></td>
				</tr><tr >

				<tr class="keychoice">
				<td ><img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/img/g_chanterelles.gif" width="125" height="100" alt=""></td>
				<td >
				...
				<td ><img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/img/g_hydnums.jpg" width="125" height="100" alt=""></td>
				</tr><tr >
				...
				<td ><img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/img/g_polypores.jpg" width="125" height="100" alt=""></td>
				</tr><tr >
				...
				<td ><img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/img/g_coral.jpg" width="125" height="100" alt=""></td>
				</tr><tr >
				...
				<td ><img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/img/g_gastroid.jpg" width="125" height="100" alt=""></td>
				</tr><tr >
				...
				<td ><img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/img/g_jelly.jpg" width="125" height="100" alt=""></td>
				</tr><tr >

				<tr class="keychoice">
				<td ><img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/img/g_rust2.jpg" width="125" height="100" alt=""></td>
				<td >
				...
				<td ><img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/img/g_rust.jpg" width="125" height="100" alt=""></td>
				</tr><tr >
				...
				<td ><img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/img/g_ascus.gif" width="125" height="100" alt=""></td>
				</tr><tr >
				...
				<td ><img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/img/g_cup.jpg" width="125" height="100" alt=""></td>
				</tr><tr >
				...
				<td ><img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/img/g_jellybaby.jpg" width="125" height="100" alt=""></td>
				</tr><tr >

				<tr class="keychoice">
				<td ><img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/img/g_flask1.jpg" width="125" height="100" alt=""></td>
				<td >
				<h3>Flask fungi</h3>
				<p>
				...
				<td ><img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/img/g_flask2.jpg" width="125" height="100" alt=""></td>
				</tr><tr >
				...
				<td ><img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/img/g_lichens.jpg" width="125" height="100" alt=""></td>
				</tr><tr >
				...
				<td ><img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/img/g_zygos.jpg" width="125" height="100" alt=""></td>
				</tr><tr >
