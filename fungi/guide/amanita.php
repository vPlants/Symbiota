...
<html>
<head>
	<title><?php echo $DEFAULT_TITLE; ?>vPlants - Guide to Amanita</title>
	...
	?>
        ...
        <div  id="innervplantstext">
            ...
            <div style="margin:20px;">
            	 <div class="floatimg"><img src="<?php echo $CLIENT_ROOT; ?>/images.vplants/fungi/guide/AMAN/AMANFLAV2.po.jpg" width="250" height="336" alt=""></div>
